...
void L6470_setup(){
// スライダは1回転 40mm
L6470_setparam_acc(0x200); //[R, WS] 加速度default 0x08A (12bit) (14.55*val+14.55[step/s^2])
L6470_setparam_dec(0x200); //[R, WS] 減速度default 0x08A (12bit) (14.55*val+14.55[step/s^2])
